...
import { ref } from "vue";
import LoginUseCase, { ILoginFields, ILoginUseCase, ILoginUseCaseResult } from "@/app/usescases/User/LoginUseCase";
...
const Submit = async () => {
  ...
  LoginResult.value = await new LoginUseCase(params).execute(LoginFields.value);
